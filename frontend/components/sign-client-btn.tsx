...
const SignClientBtn = ({ name }: { name: string }) => {
  ...
  switch (state) {
    case 1:
      return (
        <Dialog>
          <DialogTrigger className="inline-flex h-9 items-center justify-center gap-2 whitespace-nowrap rounded-md bg-sky-500 px-4 py-2 text-sm font-medium transition-colors hover:bg-sky-700 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-gray-300 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0">
            {name}
          </DialogTrigger>
          <DialogContent>
